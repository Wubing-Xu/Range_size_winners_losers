...
ras100 <- ranges[[1]][[3]]
ras200 <- ranges[[1]][[4]]
occ_rasid <- do.call(bind_rows, lapply(ranges, "[[", 5))
ahull6_suma <- do.call(bind_rows, lapply(ranges, "[[", 6))
ahull6 <- do.call(rbind, lapply(ranges, "[[", 7))
...
save(ras10, ras50, ras100, ras200, occ_rasid, file = paste(path_gbif, paste0("Species_distributions_gridcells.RDATA"), sep="/"))
